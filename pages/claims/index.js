              ...
              {(!currentUseState.isConnected) ?
                <Col lg="6" md="6" className="align-self-center">
                  ...
                  <Link href={process.env.mainWWW}>
                    <a className="btn btn-md m-t-30  btn-outline-light " style={{ backgroundColor: "#000000" }}>
                      Back Home
                    </a>
                  </Link>
                </Col> :
                <Col lg="6" md="6" className="align-self-center">
                  ...
                  {(currentUseState.isPrivateMintIsOpen) ?
                      ...
                      {(process.env.enforceWhitelist == false || currentUseState.xmPower.isWhiteListed == true) ?
                        <>
                          {(currentUseState.isWaiting == false) ?
                            <>
                              <label className="connected">Number of Claimable Rockin' Kitten's (1-{currentUseState.whiteListPass.q}):</label>
                              <div className="">
                            ...
                            <>
                              <hr />
                              <h1 className="subtitle font-light" style={{ color: "#e9e2d5"}}>Communicating with the blockchain!</h1>
                            </>}
                        </>
                        : <h1 className="subtitle font-light" style={{ color: "#e9e2d5"}}>You are not on the whitelist</h1>
                      }
                      <a
                        onClick={() => walletBridge1.disconnect()}
                        className="btn btn-md m-t-30 btn-outline-light " style={{ backgroundColor: "#000000" }}
                    ...
                    :
                    <h1 className="subtitle font-light" style={{ color: "#e9e2d5"}}>Claim mint is currently closed!</h1>
                  }
                </Col>
              }
              <Col lg="6" md="6" >
